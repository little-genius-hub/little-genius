            ...
            <CardContent className="space-y-6 p-6">
              ...
              >
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 text-purple-600 font-bold">
                    {state.language === "en"
                      ? "or continue with"
              ...
              <motion.p 
                className="text-center text-xs text-purple-600 mt-6 font-semibold bg-gradient-to-r from-purple-50/50 to-pink-50/50 p-3 rounded-lg border border-purple-100/50"
